  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-start md:items-center w-full">
            ...
            <div className="text-white space-y-4 md:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2">
                <a
                  href="https://wa.me/5493424216850?text=Hola!%20Estoy%20interesado%20en%20la%20FOTON%20TUNLAND%20G7.%20Me%20gustaría%20recibir%20más%20información."
                  target="_blank"
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div>
              ...
              <p className="text-slate-600 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
                ...
                con pantalla LCD de 7″ + pantalla secundaria táctil de 10&quot;
                integrado con sensores de estacionamiento y cámara 360°.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div>
              <h3 className="text-3xl font-black text-slate-900 mb-6">
                Potencia y <span className="text-cyan-500">confiabilidad</span>
              </h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                  <p className="text-cyan-500 font-bold text-2xl">161 HP</p>
                  <p className="text-slate-600 text-sm">Potencia máxima</p>
                </div>
                <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                  <p className="text-cyan-500 font-bold text-2xl">390 Nm</p>
                  <p className="text-slate-600 text-sm">Torque</p>
                </div>
                <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                  <p className="text-cyan-500 font-bold text-2xl">2.0 L</p>
                  <p className="text-slate-600 text-sm">Motor Diesel</p>
                </div>
                <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                  <p className="text-cyan-500 font-bold text-2xl">8 AT</p>
                  <p className="text-slate-600 text-sm">Transmisión ZF</p>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-2 lg:order-1">
              <h3 className="text-3xl font-black text-white mb-6">
                Protección <span className="text-cyan-400">total</span>
              </h3>
              <p className="text-slate-300 text-lg leading-relaxed mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  ...
                  <p className="text-white font-bold">6 Airbags</p>
                  <p className="text-slate-300 text-sm">Protección total</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <Settings className="w-8 h-8 text-cyan-400 mb-2" />
                  <p className="text-white font-bold">FCW + AEB</p>
                  <p className="text-slate-300 text-sm">Frenado emergencia</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <Settings className="w-8 h-8 text-cyan-400 mb-2" />
                  <p className="text-white font-bold">Cámara 360°</p>
                  <p className="text-slate-300 text-sm">Visión completa</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <Settings className="w-8 h-8 text-cyan-400 mb-2" />
                  <p className="text-white font-bold">ABS + ESC</p>
                  <p className="text-slate-300 text-sm">Control total</p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-6">
                La Tunland G7 es ideal para transportar cargas ya que cuenta con
                una dimension de 5.340 x 1.940 x 1.870 mm y una distancia entre
                sus ejes de 3.110 mm, además de con una capacidad de carga
                considerable de 1.000 kg.
              </p>
              <div className="grid grid-cols-2 gap-4">
      ...
      <FotonShareButton
        ...
        vehicleUrl="/foton/pick-ups/tunland-g7"
        versions={versiones}
        variant="floating"
      />
    </div>
