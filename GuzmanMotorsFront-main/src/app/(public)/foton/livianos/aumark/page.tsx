...
export default function FotonAumarkPage() {
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative min-h-screen md:min-h-[700px] lg:min-h-[800px] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="/images/FOTON/cateogries/livianos/AUMARK/HERO/HERO-FOTON-AUMARK.webp"
            alt="FOTON AUMARK"
            fill
        ...
        <div className="relative h-full container mx-auto px-4 pt-28 pb-12 md:pt-32 md:pb-16 lg:pt-24 lg:pb-20 flex items-center">
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center w-full">
            ...
            <div className="text-white space-y-4 md:space-y-6">
              {/* Logo AUMARK como título principal */}
              <div>
                <Image
                  src="/images/FOTON/cateogries/livianos/AUMARK/LOGO/LOGO-AUMARK-LETRAS.png"
                  alt="AUMARK Logo"
                  width={400}
                  height={200}
              ...
              <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-slate-200">
                El camión liviano más vendido del mundo
              </h1>

              <p className="text-sm md:text-base text-slate-300 leading-relaxed max-w-xl">
                El FOTON AUMARK es un camión liviano diseñado para la logística
                de corta distancia. Se caracteriza por su moderno diseño, alta
                calidad y tren motriz eficiente con motor Cummins, transmisión
                ZF, electrónica Bosch y frenos a disco en todas sus ruedas.
                Disponible en dos versiones: 916 y 1016 King Cab.
              </p>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      ZF Manual 6 velocidades + Reversa
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      Frenos a disco en 4 ruedas / ABS / Electrónica Bosch
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-purple-500/20 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0">
                    <Truck className="w-5 h-5 md:w-6 md:h-6 text-purple-400" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="text-white font-bold text-sm md:text-base lg:text-lg mb-0.5 md:mb-1">
                      Versiones
        ...
        <div className="absolute bottom-8 right-8 hidden xl:block">
          <Image
            src="/images/FOTON/cateogries/livianos/AUMARK/LOGO/LOGO-AUTO-AUMARK-Photoroom.png"
            alt="AUMARK"
            width={250}
            height={150}
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-black text-white mb-4 md:mb-6">
                Confort y <span className="text-cyan-500">ergonomía</span>
              </h3>
              <p className="text-slate-300 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
                El interior del FOTON AUMARK ha sido diseñado pensando en la
                comodidad del conductor y acompañantes. Cuenta con un tablero
                moderno e intuitivo, asientos ergonómicos y múltiples espacios
                de almacenamiento para facilitar las largas jornadas de trabajo.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-slate-600 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
                El FOTON AUMARK presenta un diseño exterior moderno y funcional.
                Su construcción robusta garantiza durabilidad y resistencia,
                mientras que su estética contemporánea lo distingue en las
                calles. Ideal para operaciones urbanas y logística de
                distribución.
              </p>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
          ...
          <div className="max-w-5xl mx-auto space-y-8 md:space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl md:rounded-2xl p-4 md:p-8 border border-cyan-200 hover:border-cyan-400 transition-all duration-300 shadow-lg">
              <div className="relative h-48 md:h-64 rounded-lg md:rounded-xl overflow-hidden">
                <Image
                  src="/images/FOTON/cateogries/livianos/AUMARK/COMPONENTES/MOTOR-AUMARK-.png"
                  alt="Motor AUMARK"
                  fill
              ...
              <div>
                ...
                <p className="text-slate-700 text-xs md:text-sm leading-relaxed mb-3 md:mb-4">
                  Los motores DAM a Gasolina de 1,5L, son motores muy eficientes
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl md:rounded-2xl p-4 md:p-8 border border-cyan-200 hover:border-cyan-400 transition-all duration-300 shadow-lg">
              <div className="order-2 md:order-1">
                ...
                <p className="text-slate-700 text-xs md:text-sm leading-relaxed">
                  La Caja de Cambio del AUMARK es una caja DAT18R mecánica de 5
              ...
              <div className="relative h-48 md:h-64 rounded-lg md:rounded-xl overflow-hidden order-1 md:order-2">
                <Image
                  src="/images/FOTON/cateogries/livianos/AUMARK/COMPONENTES/CAJADECAMBIOS-AUMARK-.png"
                  alt="Caja de cambios AUMARK"
                  fill
                  className="object-contain"
                />
              </div>
      ...
      <FotonShareButton
        ...
        vehicleUrl="/foton/livianos/aumark"
        versions={versiones}
        variant="floating"
      />
    </div>
