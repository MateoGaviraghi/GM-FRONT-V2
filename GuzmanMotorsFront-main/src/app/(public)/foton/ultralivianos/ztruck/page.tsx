...
export default function ZTruckPage() {
  ...
  const scrollToSection = (sectionId: string) => {
    ...
    if (element) {
      const offset = 140; // Offset para el header sticky
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative min-h-screen md:min-h-[700px] lg:min-h-[800px] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="/images/FOTON/cateogries/ultralivianos/WONDER/ZTruck/HERO/HERO-ZTRUC-FOTON.webp"
            alt="Z-Truck"
            fill
        ...
        <div className="relative h-full container mx-auto px-4 pt-28 pb-12 md:pt-32 md:pb-16 lg:pt-24 lg:pb-20 flex items-center">
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-start md:items-center w-full">
            ...
            <div className="text-white space-y-4 md:space-y-6">
              {/* Logo Z-Truck como título principal */}
              <div className="">
                <Image
                  src="/images/FOTON/cateogries/ultralivianos/WONDER/ZTruck/LOGO/LOGO-NOMBRE-ZTRUCK.png"
                  alt="Z-Truck Logo"
                  width={350}
                  height={140}
              ...
              <p className="text-sm md:text-base text-slate-300 leading-relaxed max-w-xl">
                El Z-Truck de Zanella destaca como el compañero perfecto para
                labores urbanas. Su ligereza optimiza la carga, su
                maniobrabilidad es insuperable, ofrece comodidad y diversas
                configuraciones para adaptarse a cada necesidad.
              </p>

              {/* Botón consultar */}
              <div className="pt-2">
                <a
                  href="https://wa.me/5493424216850?text=Hola!%20Estoy%20interesado%20en%20el%20Z-Truck.%20Me%20gustaría%20recibir%20más%20información."
                  target="_blank"
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      Cabina &quot;Flat Head&quot; con opciones simple o doble
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      LJ469, 4 cilindros en línea, 16 V, Euro V, Inyección
                      Multipunto
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg md:rounded-xl lg:rounded-2xl p-3 md:p-4 lg:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-slate-300 text-xs md:text-sm">690 kg</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="absolute bottom-8 right-8 hidden xl:block">
          <Image
            src="/images/FOTON/cateogries/ultralivianos/WONDER/ZTruck/LOGO/LOGO-AUTO-ZTRUCK-Photoroom.png"
            alt="Z-Truck"
            width={320}
            height={192}
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div>
              ...
              <p className="text-slate-300 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
                El Ztruck ofrece en todas sus configuraciones un interior
                espacioso y confortable, con las mismas características de un
                auto. En su versión de doble cabina el espacio trasero es amplio
                y cómodo.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-slate-600 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
                El Ztruck es un camión ultraliviano con un diseño moderno y
                atractivo que lo diferencia de otros vehículos en su categoría.
                Con gran capacidad de carga y variedad en sus configuraciones se
                convierte en el mejor aliado para el trabajo.
              </p>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-cyan-500 rounded-full"></div>
      ...
      <FotonShareButton
        vehicleName="FOTON Z-TRUCK"
        vehicleUrl="/foton/ultralivianos/ztruck"
        versions={versiones}
        variant="floating"
      />
    </div>
