    ...
    <div className="min-h-screen bg-slate-50">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm">4x4</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm">ZF AT 8 marchas</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm">720 kg</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
              ...
              <div>
                ...
                <p className="text-lg text-slate-700 mb-6 leading-relaxed">
                  En su interior cuenta con confortables asientos en eco cuero
                  con regulaciones eléctricas, tablero principal digital de
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
              ...
              <div className="order-2 lg:order-1">
                <h3 className="text-3xl font-bold text-slate-900 mb-6">
                  Diseño <span className="text-cyan-500">imponente</span>
                </h3>
                <p className="text-lg text-slate-700 mb-6 leading-relaxed">
      ...
      {activeSection === "tren-motriz" && (
        <section className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
          {/* Efectos de fondo */}
          <div className="absolute top-20 -right-20 w-96 h-96 bg-green-500 rounded-full opacity-10 blur-3xl"></div>
          <div className="absolute bottom-20 -left-20 w-96 h-96 bg-cyan-500 rounded-full opacity-10 blur-3xl"></div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto mb-16">
              ...
              <div>
                <h3 className="text-3xl font-bold mb-6">
                  Tecnología <span className="text-green-400">Mild-Hybrid</span>
                </h3>
                <p className="text-lg text-slate-300 mb-6 leading-relaxed">
                  ...
                  potencia de 175 hp. Equipada con una caja de cambios ZF AT de
                  8 marchas y una selectora que permite variar el modo de
                  conducción y la tracción, la V9 está preparada para encarar
                  todos los desafíos.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-green-500/50 transition-all duration-300">
                <div className="text-4xl font-black text-green-400 mb-2">
                  175
                </div>
                <div className="text-sm text-slate-300">Potencia (HP)</div>
              </div>
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-green-500/50 transition-all duration-300">
                <div className="text-4xl font-black text-green-400 mb-2">
                  451
                </div>
                <div className="text-sm text-slate-300">Torque (Nm)</div>
              </div>
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-green-500/50 transition-all duration-300">
                <div className="text-4xl font-black text-green-400 mb-2">
                  2.0
              ...
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-green-500/50 transition-all duration-300">
                ...
                <div className="text-sm text-slate-300">Transmisión ZF</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto mb-16">
              ...
              <div>
                <h3 className="text-3xl font-bold text-slate-900 mb-6">
                  Máxima <span className="text-cyan-500">protección</span>
                </h3>
                <p className="text-lg text-slate-700 mb-6 leading-relaxed">
                  La Tunland V9 ofrece máxima seguridad con sus 6 airbags,
                  frenos a discos con ABS, EBD y ESC, sensor de ángulo ciego,
                  FCW y AEB (frenado de emergencia). También te permite máxima
                  visibilidad con cámara 360° y sensores de retroceso.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-6 hover:shadow-xl transition-all duration-300">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto mb-12">
              ...
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg text-slate-700 mb-6 leading-relaxed">
                  En cuanto a sus dimensiones, la Foton Tunland V9 Hibrida
                  cuenta con un tamaño de 5.617 x 2.030 x 1.905 mm, con una
                  distancia entre ejes de 3.355 mm y una capacidad de carga de
                  720 kg.
                </p>
              </div>
