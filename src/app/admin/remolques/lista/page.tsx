...
export default function ListaRemolques() {
      ...
      render: (remolque) => (
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="truncate font-medium text-gray-900">{remolque.titulo}</p>
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb items={[{ label: "Remolques", href: "/admin/remolques" }, { label: "Lista" }]} />
          ...
          <div className="space-y-4">
            ...
            {mostrarFiltros ? (
              <div className="grid grid-cols-1 gap-4 border-t border-gray-100 pt-4 md:grid-cols-2 lg:grid-cols-4">
                <Field label="Condición" htmlFor="filtro-condicion">
                  <SelectField
                    id="filtro-condicion"
