  ...
  return (
    <div className="min-h-screen bg-slate-50">
            ...
            <div className="text-white space-y-4 md:space-y-6">
              ...
              <div className="">
                <Image
                  ...
                  width={280}
                  height={140}
                  className="object-contain w-full max-w-[160px] sm:max-w-[200px] md:max-w-[250px] lg:max-w-[280px]"
                  priority
                />
              </div>
              ...
              <div className="pt-2">
                <a
                  href="https://wa.me/5493424216850?text=Hola!%20Estoy%20interesado%20en%20el%20FOTON%20TM.%20Me%20gustaría%20recibir%20más%20información."
                  target="_blank"
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div>
              ...
              <p className="text-slate-600 text-base md:text-lg leading-relaxed">
                El TM ofrece en todas sus configuraciones un interior espacioso
                y confortable, con las mismas características de un auto. En su
                versión de doble cabina el espacio trasero es amplio cómodo.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-slate-300 text-base md:text-lg leading-relaxed">
                ...
                Con gran capacidad de carga y variedad en sus configuraciones TM
                mejorá la propuesta de otros utilitarios convirtiendose en el
                mejor aliado para el trabajo.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl md:rounded-2xl p-4 md:p-8 border border-blue-200 hover:border-blue-500/50 transition-all duration-300">
              <div className="order-2 md:order-1">
                ...
                <p className="text-slate-700 text-xs md:text-sm leading-relaxed">
                  La Caja de Cambio del nuevo TM es una caja DAT18R mecánica de
                  5 Velocidades adelante y una de retroceso. Una caja
      ...
      <FotonShareButton
        ...
        vehicleUrl="/foton/ultralivianos/tm"
        versions={versiones}
        variant="floating"
      />
    </div>
