    ...
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(var(--magic-bg, var(--gm-carbon-1)) 0 0) padding-box,
          radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px,
            ${gradientFrom},
            ${gradientTo},
            var(--gm-line-dark) 100%
          ) border-box
        `,
      }}
    >
      <div className="absolute inset-px z-20 rounded-[inherit] bg-[var(--magic-bg,var(--gm-carbon-1))]" />
