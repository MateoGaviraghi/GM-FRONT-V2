...
export function FotonShareModal({
  ...
  const allPdfSelected =
    hasValidVersions &&
    selectedVersions.length === versions.filter((v) => v.pdf).length;
        ...
        <div className="flex items-center justify-between border-b border-line-dark px-6 py-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="gm-label mt-2 text-steel">{vehicleName}</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          {hasValidVersions && (
            <div className="mb-8">
              <div className="mb-3 flex items-center justify-between">
                <p className="gm-label text-steel">Fichas técnicas (PDF)</p>
                <button
                  onClick={toggleAll}
                  className="gm-underline gm-label text-petrol-bright"
                >
                  {allPdfSelected ? "Deseleccionar todas" : "Seleccionar todas"}
                </button>
              </div>

              <div className="grid gap-px border border-line-dark bg-line-dark">
