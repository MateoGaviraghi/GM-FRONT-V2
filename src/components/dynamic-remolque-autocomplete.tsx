// 🚛 Componente de autocompletado dinámico para Remolques
...
import {
  ...
  useModelosByMarca,
  getOptionsFromData,
} from "@/hooks/useRemolqueOptions";
import { Loader2 } from "lucide-react";

interface DynamicRemolqueAutocompleteProps {
  id: string;
  name: string;
  value: string;
...
interface DynamicRemolqueModeloAutocompleteProps {
  id: string;
  name: string;
  value: string;
  onChange: (value: string) => void;
...
export const DynamicRemolqueAutocomplete: React.FC<
  DynamicRemolqueAutocompleteProps
> = ({
  id,
  name,
  value,
  ...
  const { options, loading, error } = useRemolqueOptions({
    isAdmin,
    enableFallback: true,
  });
...
export const DynamicRemolqueModeloAutocomplete: React.FC<
  DynamicRemolqueModeloAutocompleteProps
> = ({
  id,
  name,
  value,
